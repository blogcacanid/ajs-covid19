    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid" ng-controller="SummaryCtrl">
                    <!-- Small boxes (Stat box) -->
                    <div class="row" ng-repeat="summary in resultSummary">
                        <div class="col-lg-4 col-6">
                            <!-- small box -->
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3>{{ summary.positif }}</h3>
                                    <p>POSITIF</p>
                                </div>
                                <div class="icon">
